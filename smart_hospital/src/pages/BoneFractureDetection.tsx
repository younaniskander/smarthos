...
import { Upload, Bone, AlertCircle } from "lucide-react";
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const mockResult = {
        ...
        confidence: 0.94,
        boneType: "Tibia",
        fractureType: "Simple fracture",
        fractureLocation: "Mid-shaft",
        complexity: "simple",
      };
      ...
      <div className="space-y-6">
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold">Bone Fracture Detection</h1>
          </div>
          <p className="text-slate-600">Identify and classify bone fractures from radiographic images</p>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="border-2 border-dashed border-slate-300 rounded-lg p-8 text-center hover:border-amber-500 transition-colors cursor-pointer">
                  <input
                    type="file"
              ...
              <Card className="border-green-200 bg-green-50">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2 text-sm">
                    <div>
                      <p className="text-slate-600">Bone Type</p>
                      <p className="font-medium">{analysisResult.boneType}</p>
                    </div>
                    <div>
                      <p className="text-slate-600">Fracture Type</p>
                      <p className="font-medium">{analysisResult.fractureType}</p>
                    </div>
                    <div>
                      <p className="text-slate-600">Location</p>
                      <p className="font-medium">{analysisResult.fractureLocation}</p>
                    </div>
                    <div>
                      <p className="text-slate-600">Complexity</p>
                      <p className="font-medium capitalize">{analysisResult.complexity}</p>
                    </div>
                  </div>
